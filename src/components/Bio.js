          ...
          <div className="offset-md-4 col-md-8 offset-lg-3 col-lg-9 flex-grow-1 my-5">
            <div className="row align-items-center h-100">
              <div className="col px-5">
                <h2>Selam!</h2>
                <p>I'm Abdulrahman Y. idlbi — a.k.a. <span className="font-italic">@adlogi</span>. I was born in Saudi Arabia, grew up in Syria, studied in the US, and now living in Turkey. I'm a front-end developer with experience in ReactJS.</p>
                <p>I see coding as a form of expression: a <span className="font-italic">paintbrush</span>; and I like to use it to create experiences that help others express themselves too.</p>
